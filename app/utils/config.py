...
RAGFLOW_SIMILARITY_THRESHOLD = float(os.getenv("RAGFLOW_SIMILARITY_THRESHOLD"))
RAGFLOW_VECTOR_SIMILARITY_WEIGHT = float(os.getenv("RAGFLOW_VECTOR_SIMILARITY_WEIGHT"))
